...
(def ^:const ^:private geocode-base-url "http://api.geocod.io/v1.3/geocode")
(def ^:const ^:private parse-base-url "http://api.geocod.io/v1.3/parse")
(def ^:const ^:private reverse-base-url "http://api.geocod.io/v1.3/reverse")
